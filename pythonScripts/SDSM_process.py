...
pred_file = '../SDSM_p1/tmax/preds/tmax_p1_output_12.OUT'
predictand = 'tmax'
...
preds = xr.open_dataset(f"/glade/scratch/kwheelan/downscaling_data/SDSM_varinfl/{predictand}_lat38.125_lon-101.875/preds/finalPreds_{predictand}_38.125_-101.875.nc")
SDSM = preds.copy()
...
plotData = Plot(f"../plots/{predictand}/SDSM", lat, lon, predictand, obs = Y_all, models = {'SDSM': SDSM, 'Python': preds}, startDate = dateStart, endDate = dateEnd)
